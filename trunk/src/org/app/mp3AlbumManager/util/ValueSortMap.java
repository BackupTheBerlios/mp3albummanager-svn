...
/**
 * This class is used to show how you can sort a java.util.Map for values. This also
 * takes care of null and duplicate values present in the map.
 *
 * Author: Niraj Agarwal
 * URL: http://www.geocities.com/nirajkagarwal/html/ValueSortMap.html
 */
public class ValueSortMap {
     ...
     */
    public LinkedHashMap<Object, Object> sortMapByValue(Map inMap, Comparator comparator) {
     ...
     * @return LinkedHashMap Sorted new LinkedHashMap
     */
    public LinkedHashMap<Object, Object> sortMapByValue(Map inMap, boolean ascendingOrder) {
     ...
     * @return LinkedHashMap Sorted new LinkedHashMap
     */
    public LinkedHashMap<Object, Object> sortMapByValue(Map inMap) {
     ...
     * @return LinkedHashMap Sorted new LinkedHashMap
     */
    private LinkedHashMap<Object, Object> sortMapByValue(Map inMap, Comparator comparator, Boolean ascendingOrder)
    {
        int iSize = inMap.size();

        // Create new LinkedHashMap that need to be returned
        LinkedHashMap<Object, Object> sortedMap = new LinkedHashMap<Object, Object>(iSize);
        ...
        HashMap<Object, Object> hmNullValueMap = new HashMap<Object, Object>();
